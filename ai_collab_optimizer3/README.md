  ...
  "suggestions": [
    {
      "type": "bottleneck",
      "task_id": "task1",
      "message": "Task 'Design UI' is a bottleneck. Consider parallelizing or reducing its duration.",
      "severity": "high"
    },
    {
      "type": "workload",
      "member_email": "dev@example.com",
      "message": "Developer is overallocated. Consider redistributing tasks.",
      "severity": "medium"
    }
  ],
  "optimized_schedule": [
